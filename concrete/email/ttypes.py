...
class EmailCommunicationInfo(object):
    ...
    thrift_spec = (
        ...
        (8, TType.LIST, 'toAddressList', (TType.STRUCT, (EmailAddress, EmailAddress.thrift_spec), False), None, ),  # 8
        (9, TType.LIST, 'ccAddressList', (TType.STRUCT, (EmailAddress, EmailAddress.thrift_spec), False), None, ),  # 9
        (10, TType.LIST, 'bccAddressList', (TType.STRUCT, (EmailAddress, EmailAddress.thrift_spec), False), None, ),  # 10
