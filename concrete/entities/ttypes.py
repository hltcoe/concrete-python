...
class EntityMention(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i18 in xrange(_size14):
            _elem19 = concrete.uuid.ttypes.UUID()
            _elem19.read(iprot)
            self.childMentionIdList.append(_elem19)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.childMentionIdList is not None:
      ...
      for iter20 in self.childMentionIdList:
        iter20.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class EntityMentionSet(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i25 in xrange(_size21):
            _elem26 = EntityMention()
            _elem26.read(iprot)
            self.mentionList.append(_elem26)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.mentionList is not None:
      ...
      for iter27 in self.mentionList:
        iter27.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
