...
class ServicesException(TException):
    ...
    def __init__(self, message=None, serEx=None,):
        super(ServicesException, self).__setattr__('message', message)
        super(ServicesException, self).__setattr__('serEx', serEx)
...
class NotImplementedException(TException):
    """
    ...
    def __init__(self, message=None, serEx=None,):
        super(NotImplementedException, self).__setattr__('message', message)
        super(NotImplementedException, self).__setattr__('serEx', serEx)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('NotImplementedException')
        if self.message is not None:
            oprot.writeFieldBegin('message', TType.STRING, 1)
            oprot.writeString(self.message.encode('utf-8') if sys.version_info[0] == 2 else self.message)
            oprot.writeFieldEnd()
...
class ServiceInfo(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ServicesException)
ServicesException.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'message', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'serEx', 'BINARY', None, ),  # 2
)
all_structs.append(NotImplementedException)
NotImplementedException.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'message', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'serEx', 'BINARY', None, ),  # 2
)
all_structs.append(AsyncContactInfo)
AsyncContactInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'host', 'UTF8', None, ),  # 1
    (2, TType.I32, 'port', None, None, ),  # 2
)
all_structs.append(AnnotationUnitIdentifier)
AnnotationUnitIdentifier.thrift_spec = (
    None,  # 0
