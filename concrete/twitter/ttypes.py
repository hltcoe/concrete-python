    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.screenName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
...
class BoundingBox(object):
    ...
    thrift_spec = (
        ...
        (2, TType.LIST, 'coordinateList', (TType.STRUCT, (TwitterLatLong, TwitterLatLong.thrift_spec), False), None, ),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.locality = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.expandedUrl = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.displayUrl = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class TwitterEntities(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'hashtagList', (TType.STRUCT, (HashTag, HashTag.thrift_spec), False), None, ),  # 1
        (2, TType.LIST, 'urlList', (TType.STRUCT, (URL, URL.thrift_spec), False), None, ),  # 2
        (3, TType.LIST, 'userMentionList', (TType.STRUCT, (UserMention, UserMention.thrift_spec), False), None, ),  # 3
    )
...
class TwitterPlace(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.placeType = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.inReplyToScreenName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 16:
                if ftype == TType.I64:
