# -*- coding: utf-8 -*-
#
# concrete documentation build configuration file, created by
...
version = concrete_library_version()
# The full version, including alpha/beta/rc tags.
release = concrete_library_version()
...
latex_documents = [
    (master_doc, 'concrete.tex', u'concrete Documentation',
     u'HLTCOE', 'manual'),
]
...
man_pages = [
    (master_doc, 'concrete', u'concrete Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'concrete', u'concrete Documentation',
     author, 'concrete', 'One line description of project.',
     'Miscellaneous'),
]
