...
@mark.parametrize('which,args,output_prefix', _augment_args(1, [
    ...
    ((0, 1),
        ...
        ''),
    ((0, 1),
        ('--pos', '--pos-tool', 'fake', '--annotation-headers',),
        '\nconll\n-----\n'),
    ((0, 1, 5),
        ('--ner', '--ner-tool', 'Serif: names'),
        ''),
    ((0, 1, 5),
        ('--ner', '--ner-tool', 'Serif: names', '--annotation-headers',),
        '\nconll\n-----\n'),
    ((0, 1),
        ('--ner', '--ner-tool', 'fake'),
        ''),
    ((0, 1),
        ('--ner', '--ner-tool', 'fake', '--annotation-headers',),
        '\nconll\n-----\n'),
    ((0, 1, 6, 7),
    ...
    ((0, 1),
        ...
        ''),
    ((0, 1),
        ('--dependency', '--dependency-tool', 'fake', '--annotation-headers',),
        '\nconll\n-----\n'),
    ((0, 1, 4, 6, 7),
        ('--pos', '--dependency'),
        ''),
    ((0, 1, 4, 6, 7),
        ('--pos', '--dependency', '--annotation-headers',),
        '\nconll\n-----\n'),
    ((0, 1, 4),
    ...
    ((0, 1),
        ...
        '\nconll\n-----\n'),
    ((0, 1, 2, 4, 6, 7),
        ('--pos', '--char-offsets', '--dependency'),
        ''),
    ((0, 1, 2, 4, 6, 7),
        ('--pos', '--char-offsets', '--dependency', '--annotation-headers',),
        '\nconll\n-----\n'),
    ((0, 1, 2, 4, 5, 6, 7),
